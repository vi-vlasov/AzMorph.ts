...
export const predictionSuffixes = new Array(3).fill('');
export const prefixes = ['', 'по', 'наи'];
export let suffixes = {}; // TODO: сюда загрузить таблицу суффиксов 
export function setSuffixes(v) {
    suffixes = v;
}
export let paradigms = [];
export function setParadigms(v) {
    paradigms = v;
}
...
export function setDefaultsConfig(config) {
    defaults = config;
}
export const __init = []; // TODO: список функций инициализации (если нужен)
export const grammemes = {
    "POST": {
        "short": "ЧР",
